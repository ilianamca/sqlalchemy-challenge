...
#pt4.dates and temp of the most active station of last year
...
#pt5.calc tmin,tavg,tmax for all dates <= the start date
...
def start_only(start):
    ...
    session = Session(engine)
     ...
     #creating a date range-fixing incorrect date format
